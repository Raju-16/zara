...
document.querySelector(".left").addEventListener("click", function () {
    ...
    if (count%3 == 1 ) {
        ...
        document.querySelector("#prodsect").setAttribute("href","girlblack.html")
    }
    if (count%3 == 2 ) {
        var img1 = document.querySelector(".image1");
        ...
        document.querySelector("#prodsect").setAttribute("href","#")
    }
    if (count == -1 || count%3 == 0) {
        ...
        document.querySelector("#prodsect").setAttribute("href","manzara.html")
    }
